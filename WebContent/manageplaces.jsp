...
<body>
  ...
  <div class="main-box" >
    <div class="container">
      <div class="inside">
      <a href="managepanel.jsp"><h2 style="width:10%;margin:0 auto;">All <span>Places</span></h2></a>
      <br>
      <br>
      <br>
...
src="//pagead2.googlesyndication.com/pagead/show_ads.js">
   ...
   <form action="DeleteServlet" method="post">
       		<table >
       			...
       			<td style="border: 2px solid black;padding:5px">Entry fee</td>
       			</tr>
       			<%while(rs.next()){ %>
       			<tr>
       			...
       			<td style="border: 2px solid black;padding:5px"><img src="images/<%= rs.getString(10)%>" width=150 height=105/></td>
       		...
       		<input type="hidden" name="page" value="manageplaces.jsp"/>
       		<br>
       		<input type="submit" value="Delete Places(s)"/>
       		</form>
       			<br><br><br>
       			
       			<h2 style="font-size:1.4em"><a href="newplace.jsp">Add new place</a></h2>
	  	</div>
      </div>
    </div>
  <%}
