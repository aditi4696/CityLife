...
<body>
  ...
  <div class="main-box" >
    <div class="container">
      <div class="inside">
      <a href="managepanel.jsp"><h2 style="width:40%;margin:0 auto;">All <span>Restaurants</span></h2></a>
      <br>
      <br>
      <br>
...
src="//pagead2.googlesyndication.com/pagead/show_ads.js">
   ...
   <form action="DeleteServlet" method="post">
       		<table>
       			...
       			<td style="border: 2px solid black;padding:5px">Cuisine</td>
       			...
       			<td style="border: 2px solid black;padding:5px">7 Days Open</td>
       			<td style="border: 2px solid black;padding:5px">Free Wifi</td>
       			<td style="border: 2px solid black;padding:5px">Live Music</td>
       			<td style="border: 2px solid black;padding:5px">Live Sport Screening</td>
       			<td style="border: 2px solid black;padding:5px">Card Accepted</td>
       			<td style="border: 2px solid black;padding:5px">Paytm Accepted</td>
       			<td style="border: 2px solid black;padding:5px">Smoking Area</td>
       			<td style="border: 2px solid black;padding:5px">Bar Available</td>
       			...
       			<td style="border: 2px solid black;padding:5px"><%= rs.getString(16)%></td>
       			...
       			<td style="border: 2px solid black;padding:5px"><%= rs.getString(12)%></td>
       			<td style="border: 2px solid black;padding:5px"><%= rs.getString(13)%></td>
       			<td style="border: 2px solid black;padding:5px"><%= rs.getString(14)%></td>
       			<td style="border: 2px solid black;padding:5px"><%= rs.getString(15)%></td>
       			<td style="border: 2px solid black;padding:5px"><img src="images/<%= rs.getString(17)%>" width=150 height=105/></td>
       			</tr>
       			<%} %>
       			
       		</table>
       		<input type="hidden" name="table" value="restaurants"/>
       		<input type="hidden" name="page" value="managerestaurants.jsp"/><br>
       		<input type="submit" value="Delete Restaurant(s)"/>
       		</form>
       			<br><br><br>
       			
       			<h2 style="font-size:1.4em"><a href="newrestaurant.jsp">Add new restaurant</a></h2>
	  	</div>
      </div>
    </div>
  <%}
