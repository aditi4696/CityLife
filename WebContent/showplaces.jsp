...
<body style="background:#ffffff">
    ...
    <div class="container">
      ...
      <nav>
        <ul>
          ...
          <li><a href="showplaces.jsp"  class="current">Places</a></li>
  ...
  <section id="gallery" style="height:40%">
  	<div class="container" >
  	<object data="delhiplaces.jsp" style="height: 255px;width:1200px"></object>
  	</div>
  </section>
  <div class="main-box">
    <div class="container">
      <div class="inside">
        <%
	  		ResultSet rs=null;
	  		String table="places";
	  		String sql="select name, address, station, otime, ctime,odays, entryfee, category,pic from "+ table;
